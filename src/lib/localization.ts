...
export const EN = {
	...
	tutorial: {
		...
		game: {
			...
			step1Description: "Click cards to flip them over. Find matching pairs to summon ghosts.",
			step2Title: "Banish ghosts",
			step2Description: "When ghost appears, focus your gaze and click on the ghost.",
	...
	exportDialog: {
		...
		successMessage: "Experiment completed! TYVM!",
		errorTitle: "Error",
...
export const ZH_TW = {
	...
	tutorial: {
		...
		game: {
			...
			howToPlayLabel: "遊戲玩法：",
			step1Title: "匹配卡牌",
			step1Description: "點擊卡牌將其翻開。找到匹配的卡牌召喚幽靈。",
			step2Title: "驅逐幽靈",
			step2Description: "幽靈出現時，請將視線聚焦在幽靈身上並點擊它。",
